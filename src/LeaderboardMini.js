...
import UserCard from './LeaderboardFull'

const Leaderboard = ({onClick}) => {
    return (
        <div onClick={onClick} className="flex flex-col cursor-pointer bg-gray-1000 my-7 macAir:h-4/6 macAir:pt-6 1080p:h-3/5 macOld:h-1/2 1080p:pt-8 pt-4 col-span-2 -mx-9 items-center rounded-3xl text-white shadow-md border border-white border-opacity-5">
