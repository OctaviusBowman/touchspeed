    ...
    <div className="flex min-h-screen bg-gray-1200">
      <div className="grid grid-cols-12 px-20">
        <div className="col-span-10 bg-gradient-to-br from-gray-1000 via-gray-1100 to-gray-1100 rounded-3xl my-9 z-10 shadow-md border border-white border-opacity-5">
          <div className="grid grid-rows-8 macOld:gird-rows-4 macOld:gap-y-20 4k:gap-y-28 1080p:grid-rows-8 1080p:mx-6 4k:mx-12">
            <div className="flex pl-4 pt-3 1080p:pt-12 1080p:pb-8 1080p:px-10">
              ...
              <div className="flex-1 self-center text-center text-gray-100 -ml-4 font-thin text-5xl 1080p:pr-20 1080p:text-6xl macOld:text-8xl 4k:text-9xl">Touch Speed</div>
            </div>
            ...
            <textarea
              ...
              className="rounded focus:outline-none 4k:h-144  shadow-inner m-4 p-4 4k:text-6xl 4k:pb-32 1080p:h-72 macOld:h-80 macNew:h-96 1080p:text-3xl h-44 1080p:mb-8 1080p:rounded-2xl 4k:rounded-3xl macOld:text-4xl macOld:leading-normal 4k:leading-normal macNew:text-5xl"
