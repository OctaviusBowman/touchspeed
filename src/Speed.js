    ...
    if (symbols !== 0 && sec !== 0) {
        ...
        if (sec >= 60) {
            ...
            */
            ...
            return <div className=" font-bold text-blue-900 text-2xl">{correctWords.length} WPM</div>
        }
        return (
            <div className="font-bold text-blue-900 text-2xl">{Math.round(wpm)} WPM</div>
        );
    }
    return null;
}
